# Source: https://github.com/Blinorot/deep-learning-research/blob/summer_2026/hw/calculate_eer.py
# The only functional change is np.float -> float for NumPy 1.26 compatibility
import sys
import os
